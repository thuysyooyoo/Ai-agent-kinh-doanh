...
output_path = r'D:\AI AGENT THUY\AI agent Kinh doanh\scratch\other_sheets_analysis.txt'

with open(output_path, 'w', encoding='utf-8') as f:
    def write_sheet_summary(sheet_name):
    ...
    for sheet in ["Ước tính giá không vận chuyển", "Ước tính giá 8.4. 1 sổ", "Ước tính giá với KH khai giảm", "UT khai giảm + k ghi nhận chií"]:
        write_sheet_summary(sheet)

print("Done writing other sheets to UTF-8 file!")
